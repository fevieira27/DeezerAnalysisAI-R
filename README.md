...
## Current features:
- Searchs for **duplicated songs** within a playlist, both for exact matches and for highly likely duplicates based on song title, song duration and artist name similarity, using both the <a href="https://en.wikipedia.org/wiki/Levenshtein_distance">**Levenshtein**</a> and <a href="https://en.wikipedia.org/wiki/Jaro%E2%80%93Winkler_distance">**Jaro & Winkler**</a> distance algorithms.
